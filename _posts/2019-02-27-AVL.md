...
![左边为AVL树]({{site.url}}/images/AVL/1.png)

平衡因子BF：该节点的左子树的深度减去它的右子树深度。

![计算平衡因子即用左子树的高度减右子树的高度,红色表示该节点的深度,蓝色表示平衡因子]({{site.url}}/images/AVL/2.png)
...
![]({{site.url}}/images/AVL/3.png)

这时候的解决方法是进行右旋转。

![右旋转]({{site.url}}/images/AVL/4.png)
...
![LR的情况]({{site.url}}/images/AVL/5.png)

![LR的情况]({{site.url}}/images/AVL/6.png)

这时候需要先对x进行左旋转，转化为LL的情况

![x进行左旋转，转化为LL的情况]({{site.url}}/images/AVL/7.png)
